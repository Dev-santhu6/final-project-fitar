...
//             try {
//                 const response = await axios.get(`http://localhost:5000/api/user/getprofile/${userdetail}`);
...
//         try {
//             await axios.put(`http://localhost:5000/api/user/shop/${userdetail}`, updatedShop);
//             setShop(updatedShop);
//             toggleEditMode();
//         } catch (error) {
...
//                     <button style={{ height: '100px', width: '100px', borderRadius: '50%', overflow: 'hidden' }} className='running-border' onClick={toggleDetails}>
...
//                                     <li><p><b>Owner Name: {shop.ownername}</b></p></li>
//                                     <li><p><b>Owner Address: {shop.owneraddress}</b></p></li>
//                                     <li><p><b>Owner Phone Number: {shop.ownerphonenumber}</b></p></li>
//                                     <li><p><b>Owner Email: {shop.owneremail}</b></p></li>
//                                     <li><p><b>Shop Name: {shop.shopname}</b></p></li>
//                                     <li><p><b>Shop Address: {shop.shopaddress}</b></p></li>
//                                     <li><p><b>Shop Registration Number: {shop.shopregistrationnumber}</b></p></li>
//                                     <li><p><b>Shop Phone Number: {shop.shopphonenumber}</b></p></li>
//                                     <li><p><b>Shop Website URL: {shop.shopwebsiteURL}</b></p></li>
//                                 </ul>
//                             )}
